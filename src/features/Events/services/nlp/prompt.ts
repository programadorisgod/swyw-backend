...
3. "participants": Nombres de las personas mencionadas en el texto, separados por comas, en caso de no haber, dejar el userId
...
{"title": "<titulo>", "date": "<fecha>", "description": "<descripcion>", "participants": "nombre1, nombre2, nombre3", "userId": "<userId>", "typeEvent": "<typeEvent>", "remember": <remember>}

Texto: ${messageEvent.message}
userId: ${messageEvent.userId}
typeEvent: ${messageEvent.typeEvent}
remember: ${messageEvent.remember}
`;
